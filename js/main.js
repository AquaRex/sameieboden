import { isLocal } from "./core/env.js?v=1778517012";
import { store } from "./core/store.js?v=1778517012";
import { filterItems } from "./core/search.js?v=1778517012";
import { createSearchBar } from "./components/forms/searchBar.js?v=1778517012";
import { createTagFilters } from "./components/forms/tagFilters.js?v=1778517012";
import { createGrid } from "./components/items/grid.js?v=1778517012";
import { createViewToggle } from "./components/interactives/viewToggle.js?v=1778517012";
import { createLightbox } from "./components/overlays/lightbox.js?v=1778517012";
import { createItemDetail } from "./components/items/itemDetail.js?v=1778517012";
import { createHousePicker } from "./components/overlays/housePicker.js?v=1778517012";
import { createHouseBadge } from "./components/interactives/houseBadge.js?v=1778517012";
import { createCalendarView } from "./components/calendar/calendarView.js?v=1778517012";
import { createButton } from "./components/interactives/button.js?v=1778517012";
import { createInstallButton } from "./components/interactives/installButton.js?v=1778517012";
import { confirmDialog } from "./components/overlays/confirmDialog.js?v=1778517012";
import { createHamburgerMenu } from "./components/interactives/hamburgerMenu.js?v=1778517012";
import { createChatLauncher } from "./components/chat/chatLauncher.js?v=1778517012";
import { createChatWindow } from "./components/chat/chatWindow.js?v=1778517012";
...
import { getCurrentHouse, subscribeCurrentHouse } from "./core/currentHouse.js?v=1778517012";
import { loadItems } from "./core/serverApi.js?v=1778517012";
import { loadAllState, startRealtime, subscribeState } from "./core/state.js?v=1778517012";
import { logSessionOpen } from "./core/analytics.js?v=1778517012";
...
async function bootstrapEditable() {
  ...
  const [
    ...
    import("../sameiebodenlocal/js/components/editor.js?v=1778517012"),
    import("../sameiebodenlocal/js/components/toolbar.js?v=1778517012"),
    import("../sameiebodenlocal/js/serverWriteApi.js?v=1778517012"),
  ]);
